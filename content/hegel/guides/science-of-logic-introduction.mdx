---
title: Introduction
indexTitle: Science of Logic Introduction (Hegel)
...
Hegel complains that "the understanding"&mdash;the faculty of mind responsible
for grasping distinct and definite objects and sorting these in categories and
lists&mdash;has taken hold of philosophy, and that, what is worse, ordinary
common sense is granted dominion over the evaluation of the the truth about all
things. Ordinary common sense being rooted in sensuous reality with the notion
that thoughts are _only_ thoughts. Essentially, this view is uncritical and
philosophically naive. Mention to Kant and his transcendental philosophy will be
made here, as it is a prime example of this view. Kant's philosophy is rooted in
the idea that thoughts are _only_ thoughts and that real knowledge is the
intertwining of thoughtful form and worldly impressions.
...
> concrete immediate, in _determining_ and _parting_ it. But this reflection
...
> metaphysical significance (Hegel 2010, 27/21.31-2).
...
is simply the knowledge of empirical reality. Hegel, along with Kant, Fichte and
...
their unity, or the positive in the negative, that _the speculative_ consists"
(Hegel 2010, 35/21.41).
