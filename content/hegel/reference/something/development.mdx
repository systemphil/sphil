...
number of issues. First, he involves the category `becoming` but modifies its
...
The argument here is error prone and unconvincing, but there is an alternative.
