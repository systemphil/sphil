...
Now, Hegel then warns that this does not yield a return to the beginning of
`existence` as such. The distinction has proved to necessarily follow from
...
self-equal _through the sublation of the distinction_
```
...
the developments of `quality` that this occurs. This differs from `existence` as
such, and implies that either there are two forms of `existence` or that the
`existence` returned to is not merely `existence`.
...
flowchart LR
 ...
 subgraph Quality["Quality"]
    ...
    style Existence fill:#FFF9C4,stroke:#000000
