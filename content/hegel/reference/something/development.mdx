...
TODO it is enough to collapse the mediation into being and let that mediation
re-develop back to something, while this former something is still the case. The
fact that makes it an "other" is just that it is specifically mediated by an
other something, unlike the first something which emerges internally from
existence as such.
