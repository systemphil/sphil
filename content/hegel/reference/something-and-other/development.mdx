...
Houlgate notes that `the other` must also be negatively related to itself. "Its
self-relation must," Houlgate writes, "consist in _self-negation_, or in being
other than itself" (Houlgate 2022, 181). This process of "becoming other" is
called "change" or "alteration": "The nature of the other", Houlgate continues,
"is not only to stand apart from another thing, but also, in so doing, to
_change_" (Houlgate 2022, 181). In this respect, the logical development once
more proves to be more dynamic rather than settled and stable. A new form of
"becoming" has been re-introduced by the `other`; a "becoming" of
`becoming-other` or of "othering" oneself.
...
> cognized only as changing determinations of that which lastsY If you assume
...
change as such. As Houlgate writes, " His aim is rather to show that, even in
the absence of time, every something must change, purely by virtue of being
