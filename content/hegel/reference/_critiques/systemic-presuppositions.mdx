...
Hegel notes the importance of these in the ability to acquaint oneself with the
universal principles at stake in one's time, to give reasons for and against a
position, to be able to give an "orderly" account of the matter at hand and give
it a "serious" judgment (Hegel 2018, 5/§4). Above all, however, Hegel writes
that education should facilitate a space of the serious examination and pursuit
of a _fulfilled life_ whereby it becomes possible not merely to _reflect on the
...
SEE EL 45 / 67 [§ 19 R]. + Cont Houlgate, 105
