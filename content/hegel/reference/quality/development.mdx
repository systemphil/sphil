...
emphasize their respective ends of the connection. This emphasis actually serves
to conceal the other end. For example, determining something as real emphasizes
its `being` and conceals the implied connection to `non-being` and `negation`.
This matches the prior development at the
