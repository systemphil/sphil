...
const HeroBackground = () => {
    ...
    // TODO change with new mutation observer object
    // document.documentElement.addEventListener('DOMSubtreeModified', DOMContentListener);
    
    // Remove the event listener when the component unmounts
    // document.documentElement.removeEventListener('DOMSubtreeModified', DOMContentListener);
