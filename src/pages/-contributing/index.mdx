...
Unless you are working with a code editor on local development, you may want to check how your markdown code looks like when it has been parsed. There are several online editors available: [markdown-it demo](https://markdown-it.github.io/), [Markdown Live Preview](https://markdownlivepreview.com/), [Dillinger Markdown Editor](https://dillinger.io/). Choose one and copy-paste your contents to preview the result to see if it appears as expected. 
