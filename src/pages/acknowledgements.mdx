...
- The people at [**Vercel**](https://vercel.com/) for building and maintaining the [Next.js](https://nextjs.org/) framework.
- The people at [**Tailwind Labs**](https://github.com/tailwindlabs) for building and maintaining the [Tailwind CSS](https://tailwindcss.com/) library.
- The people at [**GitHub**](https://github.com/) for building and maintaining an awesome platform for open source projects.
- [**Shuding**](https://github.com/shuding) and the other contributors for the [Nextra](https://www.nextra.site/) documentation builder.
