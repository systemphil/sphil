...
instance of a class). For all intends and purposes, this matter may be
...
When regarding the respective transitions of `being` and `nothing`, note that in
the text concerning the development of these categories is slightly divergent.
The development of `being` ends with it turning out to be `nothing`, whereas the
