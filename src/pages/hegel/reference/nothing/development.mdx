...
Combined with the initial fragment, `nothing` is not to be understood as the absence or lack of something specific, as, for example, "there is nothing in my bank account". Rather, `nothing` _is_ complete emptiness, complete absence of any specificity, matter or existence. Internally, there is nothing to pick out since no distinction can be made. 
