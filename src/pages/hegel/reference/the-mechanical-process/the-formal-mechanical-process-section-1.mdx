...
As such, Hegel's account of `communication` would give a philosophical
explanation for why a scent diffuses through a room. Note, a philosophical
explanation does not seek to provide the material reasons for why a scent
diffuses in a room. It explains what the (onto-)logical reasons for scent
diffusion are. All of the particles in a room are treated as the same, they are
all `mechanical objects`. The diffusion of the scent, then, is explained by the
fact that the particles share an identical determinateness - they are identical.
