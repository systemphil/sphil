...
Hegel writes that “It is therefore in and for itself a
universal&mdash;universality not in the sense of a community of properties, but
a universality that pervades the particularity and in it is immediate
individuality” (Hegel 1991, 711). The reason why the objective, and by extension
the `formal mechanical process` is in-and-for-itself the universal is because
the difference between the determinations of `Concept` have been effaced.[^5] As
such, by virtue of being in-and-for itself the universal, and not needing to
give the form of universality to content, the `communication` of the
