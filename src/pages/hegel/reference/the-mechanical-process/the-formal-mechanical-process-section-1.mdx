...
[^2]: Of course, one could conceive of them as a `syllogism` or a `judgement`, but then they would cease to
...
Looking at the second half of the first paragraph of `(a)The Formal Mechanical Process`, Hegel writes that: “But even in
...
[^3]: Of course, this is based on an understanding of individuals within a society as
...
Let us have a look at the first sentence of this paragraph to get a
...
just focus on the text, however, intelligence has the effect of
...
in order to be communicated.[^4] 

[^4]: It would be a fascinating thread of further research to explain exactly 
why intelligence has the capacity to give the form
...
Hegel writes that “It is therefore in and for itself a universal&mdash;universality
...
determinations of `Concept` have been effaced.[^5] As such,
