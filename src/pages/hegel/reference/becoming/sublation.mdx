...
of keeping here cannot but entail negation. This slippage from one idea to the
...
immediacy of each vanishes so completely that there is no remnant for which it
could be considered a moment. By contrast, in `determinate being` (`existence`)
the immediacy is thoroughly negated and "each is present only as united with its
