...
longer is understood in its immediacy but as a moment of the context of
`becoming`.
...
differently, the matter at hand is not what it is. However, dialectical movement
alone is not sufficient to understand something as sublated. `Being` vanishing
into `nothing` does not thereby sublate `being`. To be something sublated, by
contrast, entails a mutated state of the category that contains its immediate
state as negated.
...
are sublated (or sublates themselves), but is, "the process through which such a
unity emerges" (Houlgate 2022, 153). Speculative thought is
[presuppositionless thought](/hegel/guides/presuppositionless-thinking) and that
entails that no determinate conception of being or rules of thought are
