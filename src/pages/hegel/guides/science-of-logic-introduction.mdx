...
strictly speaking then, cannot be merely implicit, but must have itself as its own object and that object be itself. This is what minimally constitutes pure
