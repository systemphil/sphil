...
export async function CourseCard({ course, isAdmin = false }: CourseCardProps) {
    ...
    return (
        <GlowBoundary>
            <div className="w-full rounded-lg border bg-linear-to-b from-neutral-50/90 to-neutral-100/90 transition duration-300 dark:from-neutral-950/90 dark:to-neutral-800/90 md:hover:border-transparent md:bg-linear-to-bl">
                <Link href={href}>
                    {course.imageUrl && (
                        <Image
