...
function LinkToDiscussion() {
    return (
        <a
            className="docs-focus text-xs font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 contrast-more:text-gray-700 contrast-more:dark:text-gray-100"
            target="_blank"
